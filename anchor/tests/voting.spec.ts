...
const votingAddress = new PublicKey('6J3ct9WMVLcqa5m8QsrHXY65MoFN5Drsp2b5RpAbvR83');
...
describe('Voting', () => {
	...
	it('Initialize Poll', async () => {
		await votingProgram.methods
			.initializePoll(new anchor.BN(1), 'What is your favorite type of peanut butter?', new anchor.BN(0), new anchor.BN(1821246480))
			.rpc();
